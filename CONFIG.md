...
### 4.1 需喂食发情物种（`RequireFeeding=true`，共 14 种）

到季节后头顶显示`需喂食`，需玩家把对应食物扔到地上被吃掉后才发情。

| 模板名 | 中文 | 繁殖季节 | 幼崽期 | 孕期 | 体型(公/母) | 攻击力倍率(公/母) | 可骑/可鞍 | 喂食物品 | 备注 |
|--------|------|---------|--------|------|------------|------------------|----------|---------|------|
| `Horse_Black` | 黑马 | 春季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 温顺草食，公马会争母马 |
| `Horse_Bay` | 栗色马 | 春季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 同上 |
| `Horse_Chestnut` | 红栗色马 | 春季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 同上 |
| `Horse_Palomino` | 金色马(热带) | 春季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 同上 |
| `Horse_White` | 白马(寒带) | 春季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 同上 |
| `Cow` | 母牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ❌ | 高草 | 与 Bull 互通交配，随机生 Cow/Bull |
| `Bull` | 公牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.2× / 1.0× | 0.78× / 0.6× | ❌ | 高草 | 与 Cow 互通交配，公牛不怀孕 |
| `Donkey` | 驴 | 春季 | 6 天 | 2400 秒 | 1.05× / 1.0× | 0.55× / 0.5× | ✅ | 高草 | 繁殖期/幼崽期禁止上鞍骑乘 |
| `Camel` | 骆驼 | 夏季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 同上，孕期最长 |
| `Reindeer` | 驯鹿 | 冬季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 高草 | 寒带生物，冬季发情 |
| `Ostrich` | 鸵鸟 | 春季 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ✅ | 南瓜 | 热带生物，繁殖快 |
| `Alpaca` | 羊驼 | 春/秋 | 4.5 天 | 1800 秒 | 1.05× / 1.0× | 0.33× / 0.3× | ❌ | 高草 | 温顺，可剪毛 |
| `Gnu` | 角马 | 秋季 | 6 天 | 2400 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ❌ | 高草 | 草食群居 |
| `Bison` | 野牛 | 秋季 | 6 天 | 2400 秒 | 1.15× / 1.0× | 0.91× / 0.7× | ❌ | 高草 | 攻击性中等，体型大 |

### 4.2 无需喂食物种（`RequireFeeding=false`，共 25 种）

**季节到即自动发情**，无需玩家喂食。灰狼/熊/狮子/豹子等掠食者及部分野生草食/变体在此列。

| 模板名 | 中文 | 繁殖季节 | 幼崽期 | 孕期 | 体型(公/母) | 攻击力倍率(公/母) | 可骑/可鞍 | 备注 |
|--------|------|---------|--------|------|------------|------------------|----------|------|
| `Wolf_Gray` | 灰狼 | 冬季 | 4.5 天 | 1800 秒 | 1.3× / 1.0× | 1.3× / 1.0× | ❌ | 无需喂食，冬季自动发情，攻击性强 |
| `Bear` | 灰熊 | 夏季 | 6 天 | 2400 秒 | 1.2× / 1.1× | 1.56× / 1.2× | ❌ | 大型杂食掠食者，攻击力高 |
| `Bear_Brown` | 棕熊 | 夏季 | 6 天 | 2400 秒 | 1.2× / 1.1× | 1.56× / 1.2× | ❌ | 同灰熊 |
| `Bear_Black` | 黑熊 | 夏季 | 6 天 | 2400 秒 | 1.15× / 1.05× | 1.43× / 1.1× | ❌ | 比棕熊略小 |
| `Bear_Polar` | 北极熊 | 冬季 | 6 天 | 2400 秒 | 1.25× / 1.15× | 1.69× / 1.3× | ❌ | 寒带大型掠食者，攻击力极高 |
| `Lion` | 狮子 | 夏季 | 6 天 | 2400 秒 | 1.2× / 1.0× | 1.68× / 1.2× | ❌ | 群居顶级掠食者 |
| `Tiger` | 老虎 | 秋季 | 6 天 | 2400 秒 | 1.25× / 1.05× | 1.82× / 1.3× | ❌ | 独居顶级掠食者，攻击力极高 |
| `Tiger_White` | 白虎 | 秋季 | 6 天 | 2400 秒 | 1.25× / 1.05× | 1.82× / 1.3× | ❌ | 老虎稀有变体 |
| `Leopard` | 豹子 | 秋季 | 6 天 | 2400 秒 | 1.15× / 1.0× | 1.43× / 1.1× | ❌ | 敏捷掠食者 |
| `Jaguar` | 美洲豹 | 夏季 | 6 天 | 2400 秒 | 1.15× / 1.0× | 1.43× / 1.1× | ❌ | 热带掠食者 |
| `Hyena` | 鬣狗 | 春季 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 1.08× / 0.9× | ❌ | 群居 scavenger，攻击力中等 |
| `Wildboar` | 野猪 | 秋季 | 4.5 天 | 1800 秒 | 1.15× / 1.0× | 1.04× / 0.8× | ❌ | 杂食中型动物 |
| `Moose` | 驼鹿 | 秋季 | 6 天 | 2400 秒 | 1.3× / 1.1× | 1.26× / 0.9× | ❌ | 大型草食，寒带，公鹿体型大 |
| `Rhino` | 犀牛 | 夏季 | 6 天 | 2400 秒 | 1.25× / 1.1× | 1.54× / 1.1× | ❌ | 大型草食，攻击性强 |
| `Giraffe` | 长颈鹿 | 夏季 | 6 天 | 2400 秒 | 1.2× / 1.1× | 0.91× / 0.7× | ❌ | 超大型草食，孕期最长 |
| `Zebra` | 斑马 | 春季 | 6 天 | 2400 秒 | 1.15× / 1.0× | 0.72× / 0.6× | ❌ | 群居草食，警惕性高 |
| `Wolf_Coyote` | 郊狼 | 冬季 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.96× / 0.8× | ❌ | 比灰狼小，孕期短 |
| `Cow_Black` | 黑母牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ❌ | 与 Bull* 互通交配，生 Cow_Black/Bull_Black |
| `Cow_Brown` | 棕母牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.6× / 0.5× | ❌ | 与 Bull* 互通交配，生 Cow_Brown/Bull_Brown |
| `Bull_Brown` | 棕公牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.2× / 1.0× | 0.78× / 0.6× | ❌ | Bull 棕色变体 |
| `Bull_Black` | 黑公牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.2× / 1.0× | 0.78× / 0.6× | ❌ | Bull 黑色变体 |
| `Bull_White` | 白公牛 | 春/夏 | 4.5 天 | 1800 秒 | 1.2× / 1.0× | 0.78× / 0.6× | ❌ | Bull 白色变体 |
| `Alpaca_Shorn` | 剃毛羊驼 | 春/秋 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.33× / 0.3× | ❌ | Alpaca 剃毛变体 |
| `Alpaca_White` | 白羊驼 | 春/秋 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.33× / 0.3× | ❌ | Alpaca 白色变体 |
| `Cassowary` | 鹤鸵 | 夏季 | 4.5 天 | 1800 秒 | 1.1× / 1.0× | 0.96× / 0.8× | ✅ | 大型不会飞的鸟，攻击性强 |

> **喂食发情说明**：上表 4.1 的 14 种生物默认开启了条件性繁衍（`RequireFeeding=true`），需玩家把对应食物扔到地上被吃掉后才会发情。4.2 的 25 种生物**无需喂食**，季节到即自动发情（含灰狼）。
>
...
>
> **可骑乘物种交互拦截**：`Horse`/`Donkey`/`Camel`/`Reindeer`/`Ostrich`/`Cassowary` 在繁殖期（发情/怀孕/虚弱）和幼崽期禁止上鞍+骑乘。详见上文"交互拦截参数"。
>
